...
final class AuthService {
    ...
    func register(username: String, password: String, name: String, email: String? = nil, inviteCode: String? = nil, householdName: String? = nil) async throws {
        let response = try await api.register(username: username, password: password, name: name, email: email, inviteCode: inviteCode, householdName: householdName)
