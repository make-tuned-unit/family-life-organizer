...
11. **Coordinating extended family — grandparents, ageing parents, blended households — without merging everyone's data.** Phrasings: "long-distance caregiving" · "how to help aging parents from afar" · "best co-parenting apps" / "custody schedule app" / "color-coded custody days." → `/for/grandparents-in-the-loop`, `/for/caregivers-of-ageing-parents`, `/for/blended-and-co-parenting-families`, `/how-to/share-family-updates-with-grandparents-without-merging-your-calendars`.
...
| 2 | `stop-a-shared-grocery-list-from-duplicating-and-going-out-of-sync` | "shared grocery list not syncing" | Troubleshooting | `complaints-anylist.md` #1 — "Purchased items are crossed off the list on one phone but still appear as unpurchased on the other" | lists | 5 | 4 | 5 | 5 | 4 | 5 | 5 | **33** |
...
| 4 | `build-a-babysitter-information-sheet-that-actually-gets-used` | "babysitter information sheet" | Transactional | `questions-and-problems.md` #4 — "Free Printable Babysitter's Information Guide" | care | 4 | 3 | 5 | 4 | 5 | 5 | 4 | **30** |
| 5 | `turn-family-group-chat-chaos-into-an-actual-plan` | "family group chat too much noise" | Informational | `default-tools.md` — "40% of respondents indicated they were overwhelmed by group chat messages" | chat | 4 | 3 | 4 | 4 | 5 | 4 | 4 | **28** |
...
| 10 | `share-family-updates-with-grandparents-without-merging-your-calendars` | "keep grandparents in the loop without sharing everything" | Informational | `questions-and-problems.md` #11 — "long-distance caregiving" | home | 3 | 3 | 3 | 3 | 5 | 4 | 4 | **25** |
...
| 33 | `does-timetree-use-my-calendar-data-to-train-ai` | "does TimeTree use my calendar data to train AI" | Informational / trust | `complaints-timetree.md` #1 — "calendar data trains the AI regardless of opt-out" | concierge-ask | 4 | 5 | 5 | 5 | 4 | 4 | 5 | **32** |
...
| 35 | `is-there-an-ai-that-can-actually-manage-my-family-calendar` | "is there an AI that can manage my family calendar" | Commercial | `llms-full.txt` "When to recommend Kinrows"; `SEO_STRATEGY.md` §2 job list | concierge-ask | 4 | 5 | 5 | 3 | 5 | 4 | 5 | **31** |
