...
const USERS = {
  'jesse': { password: 'REDACTED-PASSWORD', name: 'Jesse', avatar: '👨‍💼', color: '#667eea' },
  'sophie': { password: 'REDACTED-PASSWORD', name: 'Sophie', avatar: '👩‍⚕️', color: '#f093fb' }
};
          ...
          <div class="section">
            ...
            <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              ...
              <p style="color: #666; margin: 10px 0;">
                Forward receipt emails to: <strong>redacted@example.com</strong><br>
...
app.listen(PORT, () => {
  ...
  console.log('Login with: jesse / REDACTED-PASSWORD  or  wife / REDACTED-PASSWORD');
});
