...
const CASES = [
  ...
  { say: 'Jude just went down for the night', tool: 'routines', actions: ['start_sleep', 'list'] },
  { say: 'actually he went down at 7:30, not now', tool: 'routines', actions: ['set_start', 'list'] },
  { say: 'Jude is awake', tool: 'routines', actions: ['end_sleep', 'list'] },
  { say: 'why is Jude waking up at 4am every second night?', tool: 'routines', actions: ['analyze', 'list'] },
  { say: 'what could we try differently to get him through the night?', tool: 'routines', actions: ['analyze', 'list'] },
  { say: 'what does the sleep data say about Jude?', tool: 'routines', actions: ['analyze', 'stats', 'list'] },
  { say: 'is Jude getting enough sleep?', tool: 'routines', actions: ['stats', 'analyze', 'list'] },
  { say: 'Jude fed the dog this morning', tool: 'routines', actions: ['log_chore', 'list', 'chores'] },
  { say: 'did Jude do his chores today?', tool: 'routines', actions: ['chores', 'list'] },
  { say: 'Jude had a great bedtime tonight', tool: 'routines', actions: ['chore_bonus', 'list', 'chores'] },
  { say: 'how much allowance does Jude get this week?', tool: 'routines', actions: ['chores', 'list'] },
  { say: 'is Jude ready for a second chore?', tool: 'routines', actions: ['chores', 'list'] },
  { say: 'set up chores for Jude: feed the dog morning and evening, $2 a week, $1 bonus for good bedtimes', tool: 'routines', actions: ['setup_chores'] },
  { say: "add making the bed to Jude's chores", tool: 'routines', actions: ['update_chores', 'list', 'chores'] },
  { say: "raise Jude's allowance to $3 a week", tool: 'routines', actions: ['update_chores', 'list'] },
  { say: 'I paid Jude his allowance', tool: 'routines', actions: ['chore_payout', 'list'] },
