  ...
  initSchema() {
    return new Promise((resolve, reject) => {
      ...
      this.db.serialize(() => {
        ...
        // last_location_at already exists on fresh schemas; ALTER is for older
        // DBs. Duplicate-column errors are expected and ignored (same as every
        // other ADD COLUMN above).
        this.db.run('ALTER TABLE users ADD COLUMN last_location_at DATETIME', () => {
